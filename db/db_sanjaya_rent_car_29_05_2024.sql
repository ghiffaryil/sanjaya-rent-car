...
(1, 'Toyota Innova Reborn 2023', '29882b436a897cf2ce1118194c35d178_1_Foto.jpg', '5', 'Spesifikasi Toyota Kijang Innova Reborn Overview Merek: Toyota Model: Toyota Kijang Innova Type Body: MPV Segmen: Segmen C Jenis bahan bakar: Fuel Tahun peluncuran: 2020 Tenaga maksimum (ps): 139 PS, 149 PS Torsi maksimal (NM): 183 Nm, 342 Nm Mesin: 2.0L petrol Engine, In-Line 4 Cylinder 16 Valve DOHC Panjang x Lebar x Tinggi (mm): 4735 x 1830 x 1795 Performance Perpindahan mesin: 1998 cc, 2393 cc Tenaga maksimum: 139 PS, 149 PS Jenis bahan bakar: Bensin Torsi: 183Nm, 342Nm Dimensi dan kapasitas Panjang (mm): 4735 Lebar (mm): 1830 Tinggi (mm): 1795 Jarak sumbu roda: (mm): 2750 Berat besih (kg): 1 Ground Clearance (mm): 1 Jumlah pintu (buah): 5 Jumlah tempat duduk (buah): 7 Tangki bahan bakar (liter): 1 Kapasitas bagasi (L): 1 Kemudi dan Suspensi Suspense depan: Double Wishbone Suspense belakang: Multi-Link Tipe Power Steering: Rack & Pinion Detail Mesin Kapasitas mesin (L): 1.0 Kapasitas mesin (cc): 1998, 2393 Jumlah silinder: 4 Jumlah katup per silinder: 4 Tenaga maksimum (PS): 139 hingga 149 Rpm at Max Tenaga: 3400 hingga 5600 Torsi maksimum (Nm: 183 hingga 342 Rpm at Max Torsi: 4000, 1200-2800 Jenis bahan bakar: bensin Rem dan Ban Jenis rem depan: Ventilated Disc Jenis rem belakang: Drum Spesifikasi ban depan: 205/65 R16 Spesifikasi ban belakang: 205/65 R16', NULL, 'Wooden Pallet', 'A wooden pallet is a tool or base made of wood and used to support and facilitate the process of loading and unloading goods. The existence of wooden pallets has become an integral part of the global supply chain, facilitating the efficient delivery and storage of goods throughout the world. The use of wooden pallets is very broad, found in various industries ranging from manufacturing, logistics, agriculture, to e-commerce trade. Its flexibility and reliability make wooden pallets the main choice for companies that prioritize efficiency in the distribution of their goods.\r\n<br>\r\nOne of the main advantages of wooden pallets is their strength and durability. Compared to other materials such as plastic or cardboard, wood provides superior strength that can support heavy loads. This allows items to be stacked and transported safely, reducing the risk of damage during the shipping process. Apart from that, wood is also relatively easy to process and repair if damaged, making wooden pallets an economical choice in the long term.', 699000, 'Driver;BBM;Paket Minuman', '2024-02-29 10:19:42', 'Aktif'),
