...
if (isset($_POST['submit_simpan'])) {
    if ($cek_required == "Sukses") {
        ...
        if ($result['Status'] == "Sukses") {
            ...
            $a_result_terbaru = $a_tambah_baca_update_hapus->baca_data_terbaru("tb_newsletter", "Id_Newsletter");
...
if (isset($_GET['edit'])) {
    ...
    $result = $a_tambah_baca_update_hapus->baca_data_id("tb_newsletter", "Id_Newsletter", $Get_Id_Primary);
...
if (isset($_POST['submit_update'])) {
    if ($cek_required == "Sukses") {
        ...
        $result = $a_tambah_baca_update_hapus->update_data("tb_newsletter", $form_field, $form_value, $form_field_where, $form_criteria_where, $form_value_where, $form_connector_where);
...
if (isset($_GET['hapus_data_ke_tong_sampah'])) {
    ...
    $result = $a_tambah_baca_update_hapus->hapus_data_ke_tong_sampah("tb_newsletter", "Id_Newsletter", $Get_Id_Primary);
...
if (isset($_GET['arsip_data'])) {
    ...
    $result = $a_tambah_baca_update_hapus->arsip_data("tb_newsletter", "Id_Newsletter", $Get_Id_Primary);
...
if (isset($_GET['restore_data_dari_arsip'])) {
    ...
    $result = $a_tambah_baca_update_hapus->restore_data_dari_arsip("tb_newsletter", "Id_Newsletter", $Get_Id_Primary);
...
if (isset($_GET['restore_data_dari_tong_sampah'])) {
    ...
    $result = $a_tambah_baca_update_hapus->restore_data_dari_tong_sampah("tb_newsletter", "Id_Newsletter", $Get_Id_Primary);
...
if (isset($_GET['hapus_data_permanen'])) {
    ...
    // READ DATA
    $result_data = $a_tambah_baca_update_hapus->baca_data_id("tb_newsletter", "Id_Newsletter", $Get_Id_Primary);

    if ($result_data['Status'] == "Sukses") {
        $data = $result_data['Hasil'];

        $Foto = $data['Foto'];
        $temp_file_location = "media/Newsletter/" . $Foto;
    ...
    $result = $a_tambah_baca_update_hapus->hapus_data_permanen("tb_newsletter", "Id_Newsletter", $Get_Id_Primary);
    if ($result['Status'] == "Sukses") {
...
$hitung_Aktif = $a_tambah_baca_update_hapus->hitung_data_dengan_filter("tb_newsletter", $count_field_where, $count_criteria_where, $count_value_where, $count_connector_where);
$hitung_Aktif = $hitung_Aktif['Hasil'];
//DATA TERARSIP
$count_value_where = array("Terarsip");
$hitung_Terarsip = $a_tambah_baca_update_hapus->hitung_data_dengan_filter("tb_newsletter", $count_field_where, $count_criteria_where, $count_value_where, $count_connector_where);
$hitung_Terarsip = $hitung_Terarsip['Hasil'];
//DATA TERHAPUS (SAMPAH)
$count_value_where = array("Terhapus");
$hitung_Terhapus = $a_tambah_baca_update_hapus->hitung_data_dengan_filter("tb_newsletter", $count_field_where, $count_criteria_where, $count_value_where, $count_connector_where);
    ...
    <div class="container-full">
        ...
        <div class="content-header">
            <div class="d-flex align-items-center">
                <div class="me-auto">
                    <h3 class="page-title">Data Newsletter</h3>
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="dashboard.php"><i class="mdi mdi-home-outline"></i> Home</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Data Newsletter</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                            ...
                                            if ($result['Status'] == "Sukses") {
                                                ...
                                                foreach ($data_hasil as $data) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo $kehalaman ?>&edit&id=<?php echo $a_hash->encode($data["Id_Newsletter"], $_GET['menu']); ?>">
                                                                <?php echo $data['Email'] ?>
                                                            </a>
                                                        </td>
